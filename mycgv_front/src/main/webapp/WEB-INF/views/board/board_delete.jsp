...
<body>
	<!-- Header Include -->
	<iframe src="http://localhost:9000/header.do" width="100%" height="160px" scrolling="no" frameborder=0 ></iframe>
	...
	<!-- footer Include -->
	<iframe src="http://localhost:9000/footer.do" width="100%" height="530px" scrolling="no" frameborder=0></iframe>
